...
def relu_with_scaled_sigmoid_model(channels=1, learning_rate=0.005, drop_rate=0.1):
    ...
    concat_4_0 = concatenate([flatten_3a_3, flatten_3b_3, speed_input, yaw_input])
    ...
    model = Model(inputs=[image, minimap, speed_input, yaw_input], outputs=output)
