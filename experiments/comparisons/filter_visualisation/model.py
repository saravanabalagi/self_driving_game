...
def tanh_model(channels=1, learning_rate=0.001, drop_rate=0.2):
    ...
    drop_1_2 = Dropout(drop_rate, seed=0, name='drop_1_2')(pool_1_2)

    conv_2_1 = Conv2D(64, (3, 3), kernel_initializer='normal', activation='tanh', name='conv_2_1')(drop_1_2)
    ...
    drop_2_3 = Dropout(drop_rate, seed=0, name='drop_2_3')(pool_2_3)
	
    conv_3_1 = Conv2D(128, (3, 3), kernel_initializer='normal', activation='tanh', name='conv_3_1')(drop_2_3)
    ...
    drop_3_3 = Dropout(drop_rate, seed=0, name='drop_3_3')(pool_3_3)
    flatten_3_3 = Flatten(name='flatten_3_3')(drop_3_3)
...
def relu_with_scaled_sigmoid_model(channels=3, learning_rate=0.001, drop_rate=0.2):
    ...
    conv_2_1 = Conv2D(64, (3, 3), kernel_initializer='normal', activation='relu', name='conv_2_1')(drop_1_2)
    conv_2_2 = Conv2D(64, (3, 3), kernel_initializer='normal', activation='relu', name='conv_2_2')(conv_2_1)
    conv_2_3 = Conv2D(64, (3, 3), kernel_initializer='normal', activation='relu', name='conv_2_3')(conv_2_2)
    pool_2_3 = MaxPooling2D(pool_size=(2,2), name='pool_2_3')(conv_2_3)
    drop_2_3 = Dropout(drop_rate, seed=0, name='drop_2_3')(pool_2_3)

    conv_3_1 = Conv2D(128, (3, 3), kernel_initializer='normal', activation='relu', name='conv_3_1')(drop_2_3)
    conv_3_2 = Conv2D(128, (3, 3), kernel_initializer='normal', activation='relu', name='conv_3_2')(conv_3_1)
    conv_3_3 = Conv2D(128, (3, 3), kernel_initializer='normal', activation='relu', name='conv_3_3')(conv_3_2)
    pool_3_3 = MaxPooling2D(pool_size=(2,2), name='pool_3_3')(conv_3_3)
    drop_3_3 = Dropout(drop_rate, seed=0, name='drop_3_3')(pool_3_3)
